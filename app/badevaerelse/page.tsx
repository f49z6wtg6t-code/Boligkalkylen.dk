      ...
      result={
        <>
          ...
          <FAQSection items={[
            ...
            { question: "Hvad koster et nyt badeværelse i gennemsnit pr. kvm?", answer: "En totalrenovering koster typisk 20.000–25.000 kr. pr. kvm inkl. VVS, el, membran, fliser og sanitet. Med premium materialer stiger prisen til 30.000+ kr. pr. kvm. Bemærk at prisen pr. kvm falder relativt ved større badeværelser — arbejdslønnen for VVS og el er tilnærmelsesvis fast uanset størrelse, mens materialeforbruget skalerer med arealet." },
            { question: "Hvor lang tid tager en totalrenovering af et badeværelse?", answer: "En totalrenovering af et standard badeværelse på 5–10 kvm tager typisk 4–7 uger fra opstart til færdigt resultat. De vigtigste tidsfaktorer er: membranens tørretid (3–5 dage), fliseklægning (3–6 dage afhænger af mønster og størrelse), og levering af materialer. Importerede fliser fra Spanien, Portugal eller Belgien har typisk 4–8 ugers leveringstid — bestil materialer inden du bekræfter opstartstidspunktet med håndværkeren, ellers kan projektet stoppe midt i." },
            { question: "Kan man spare penge ved selv at nedrive det gamle badeværelse?", answer: "Ja — nedrivning er en af de få opgaver du lovligt kan gøre selv uden autorisation. En håndværker bruger typisk 1–2 dage på nedrivning til en pris af 3.000–6.000 kr. i arbejdsløn. Ved at gøre det selv kan du spare dette beløb. Husk dog: bor du i hus fra før 1988, kan der være asbest i gulvbelægningen eller bag vægbeklædningen — få det vurderet inden du river noget ned. Asbestholdige materialer kræver specialhåndtering og må ikke bortskaffes som almindeligt byggeaffald." },
          ]} />
        </>
      }
    >
