    ...
    <CalculatorShell
      ...
      result={
        <>
          ...
          <FAQSection items={[
            { question: "Hvad koster et nyt badeværelse i 2026?", answer: "Prisen på en badeværelsesrenovering afhænger meget af størrelse og omfang. En overfladisk renovering (fliser, inventar, maling) koster typisk 30.000–80.000 kr., mens en totalrenovering inkl. VVS koster 130.000–300.000 kr. for et standard badeværelse på 5–10 kvm." },
            { question: "Hvad koster et badeværelse pr. kvm?", answer: "En totalrenovering koster typisk 15.000–25.000 kr. pr. kvm inkl. VVS, fliser og inventar. Premium-materialer kan øge prisen til 30.000+ kr. pr. kvm. Prisen pr. kvm falder relativt set ved større badeværelser." },
