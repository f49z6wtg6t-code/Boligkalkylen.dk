      ...
      result={
        <>
          ...
          <FAQSection items={[
            ...
            { question: "Hvor mange år tager det før et solcelleanlæg har tjent sig hjem?", answer: "Den typiske tilbagebetalingstid for et solcelleanlæg i Danmark er 9–11 år i 2026. Det afhænger primært af anlæggets størrelse, tagorientering og dit elforbrug. Et syd-vendt tag med optimalt hældning giver den korteste tilbagebetalingstid. Herefter producerer anlægget reelt gratis strøm i de resterende 14–16 år af dets levetid på 25–30 år — den samlede nettobesparelse over 25 år er typisk 75.000–130.000 kr. for et standard parcelhus-anlæg." },
            { question: "Kræver det byggetilladelse at få solceller på taget?", answer: "Som udgangspunkt nej. Solceller kræver ikke byggetilladelse i Danmark hvis de monteres direkte på taget og følger tagets hældning. Der er dog undtagelser: bor du i et fredet område, en bevaringsværdig bygning eller i visse villakvarterer med særlige lokalplaner (fx dele af Indre København, Frederiksberg eller Nordsjælland), skal du kontakte kommunen inden installation. Bor du i ejerforening eller andelsbolig, skal du desuden have bestyrelsens skriftlige godkendelse — selv uden kommunal byggetilladelse." },
            { question: "Hvad sker der med strømmen, hvis jeg producerer mere end jeg bruger?", answer: "Overskudsstrøm sælges automatisk til elnettet via din nettoafregningsaftale. Fra 2026 gælder øjebliksafregning (gruppe 3) for alle nye anlæg — overskudsstrøm afregnes til den aktuelle spotpris i det øjeblik den produceres, typisk 0,30–0,60 kr./kWh afhængigt af tidspunkt på dagen. Det er markant lavere end den pris du betaler for at købe strøm (ca. 2,50 kr./kWh), hvilket er årsagen til at det altid er mest værdifuldt at bruge strømmen selv. Et batteri kan øge selvforbruget fra typisk 35% til 60–75% ved at gemme overskudsproduktion til aftenforbrug." },
          ]} />
        </>
      }
    >
